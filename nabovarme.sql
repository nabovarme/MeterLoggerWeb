...
CREATE TABLE `wifi_scan` (
  ...
  `auth_mode` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pairwise_cipher` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `group_cipher` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phy_11b` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phy_11g` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phy_11n` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `wps` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unix_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `serial_unix_time_idx` (`serial`,`unix_time`),
  KEY `ssid_idx` (`ssid`),
